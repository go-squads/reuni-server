...
func CreateRouter() *mux.Router {
	...
	router.HandleFunc("/organization/{organization_name}/member", withAuthenticator(organizationAuthorizator(organization.AddUserHandler, 'w'))).Methods("POST")
	router.HandleFunc("/organization/{organization_name}/member", withAuthenticator(organizationAuthorizator(organization.DeleteUserFromGroupHandler, 'w'))).Methods("DELETE")
	router.HandleFunc("/organization/{organization_name}/member", withAuthenticator(organizationAuthorizator(organization.UpdateRoleOfUserHandler, 'w'))).Methods("PATCH")
	router.HandleFunc("/organization/{organization_name}/member", withAuthenticator(organization.GetAllMemberOfOrganizationHandler)).Methods("GET")
