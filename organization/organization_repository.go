...
const (
	...
	getAllMemberOfOrganizationQuery = "SELECT U.id, U.name, U.username, OM.role, OM.created_at FROM organization_member OM, users U WHERE OM.user_id = U.id AND OM.organization_id=$1"
